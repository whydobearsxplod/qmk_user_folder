...
KC_Q,   KC_W,   KC_E,   KC_R,   KC_T,   KC_Y,   KC_U,    KC_I,   KC_O,     KC_P, KC_NO, KC_7,KC_8,KC_9,
   ...
   MT(MOD_LSFT, KC_Z),   KC_X,   KC_C,   KC_V,   KC_B,   KC_N,   KC_M, KC_COMMA, KC_DOT,MT(MOD_LGUI,KC_SLSH), KC_NO,KC_1,KC_2,KC_3,
  KC_LCTL, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, LT(_NUM_SYM,KC_SPACE), KC_RALT, KC_NO,  KC_0, KC_DOT, KC_ENT
  ),
